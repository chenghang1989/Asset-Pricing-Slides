...
\begin{frame}{Choosing the Bandwidth $L$}
	\begin{itemize}
		...
		\item \textbf{Automatic selection}: \href{https://doi.org/10.2307/2951574}{\textcolor{blue}{Andrews and Monahan (1992)}} propose data-driven bandwidth selection
	\end{itemize}
...
\begin{frame}{Stambaugh Bias: Intuition}
	...
	\textbf{Solutions}:
	\begin{itemize}
		\item \href{https://doi.org/10.1016/j.jfineco.2002.11.002}{\textcolor{blue}{Lewellen (2004)}}: Bias-adjusted estimator
		\item \href{https://doi.org/10.1017/S0022109000003227}{\textcolor{blue}{Amihud and Hurvich (2004)}}: Augmented regression
...
\begin{frame}{Overlapping Observations Problem}
	...
	\begin{itemize}
		...
		\item \href{https://doi.org/10.1093/rfs/5.3.357}{\textcolor{blue}{Hodrick (1992)}} standard errors
...
\begin{frame}{Hodrick Standard Errors}
	...
	\vspace{5pt}
	\textbf{Key insight} (\href{https://doi.org/10.1093/rfs/hhl021}{\textcolor{blue}{Ang and Bekaert (2007)}}): Hodrick standard errors have better finite-sample properties than Newey-West for long-horizon regressions.
\end{frame}

\begin{frame}{Data Snooping and Multiple Testing}
	\href{https://doi.org/10.1093/rfs/hhv059}{\textcolor{blue}{Harvey, Liu, and Zhu (2016)}}: ``...and the Cross-Section of Expected Returns''
	...
	\begin{itemize}
		...
		\item \href{https://doi.org/10.1111/jofi.12530}{\textcolor{blue}{Harvey (2017)}}: Require $|t| > 3.0$ for significance
