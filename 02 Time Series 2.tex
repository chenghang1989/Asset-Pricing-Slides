...
\begin{frame}{Why Out-of-Sample Testing Matters}
    \begin{itemize}
        ...
        \item \textbf{Debate}:
        \begin{itemize}
            \item \href{https://doi.org/10.1093/rfs/hhm014}{\textcolor{blue}{Goyal and Welch (2008)}}: OOS is a \textit{necessary complement} to IS.
...
\begin{frame}{OOS $R^2$: The Core Statistic}
    ...
    \vspace{0.3cm}
    \textbf{OOS $R^2$} (\href{https://doi.org/10.1093/rfs/hhm014}{\textcolor{blue}{Goyal and Welch, 2008}}):
    \begin{equation}
...
\begin{frame}{OOS Graphical Diagnostic: Cumulative SSE Difference}
     \href{https://doi.org/10.1093/rfs/hhm014}{\textcolor{blue}{Goyal and Welch (2008)}} popularized the following diagnostic plot:
    \begin{equation}
...
\begin{frame}[allowframebreaks]{Goyal and Welch (2008): Main Results}
    \textbf{Paper}: \href{https://doi.org/10.1093/rfs/hhm014}{\textcolor{blue}{Goyal and Welch (RFS, 2008)}} examined \textbf{17 predictor variables} (1872--2005):
    \begin{itemize}
    ...
    \textbf{Four Criteria for a Well-Specified Signal} (\href{https://doi.org/10.1093/rfs/hhm014}{\textcolor{blue}{Goyal and Welch (2008)}}):
    \begin{enumerate}
