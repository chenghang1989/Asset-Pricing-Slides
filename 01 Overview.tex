...
\begin{tabular}{cl}
	...
	2020 & \href{https://doi.org/10.1093/rfs/hhz123}{\textcolor{blue}{Gu-Kelly-Xiu: Machine Learning in Asset Pricing}} \\
	\bottomrule
\end{tabular}
\end{center}
}
...
\begin{frame}{Additional Resources}
	\begin{itemize}
		...
		\begin{itemize}
			\item \href{https://doi.org/10.1146/annurev-financial-110311-101826}{\textcolor{blue}{Nagel (2013)}}: Empirical Cross-Sectional Asset Pricing
			\item \href{https://doi.org/10.1146/annurev-financial-110217-022705}{\textcolor{blue}{Harvey, Liu, and Zhu (2016)}}: ... and the Cross-Section of Expected Returns
			\item \href{https://doi.org/10.1016/j.jfineco.2019.06.008}{\textcolor{blue}{Giglio, Kelly, and Xiu (2022)}}: Factor Models, Machine Learning...
		\end{itemize}
...
\begin{frame}{Major Solutions to Puzzles in C-CAPM}
	\begin{itemize}
		...
		\end{itemize}
		\item \textbf{Rare Disasters} (\href{https://doi.org/10.1257/aer.98.5.2066}{\textcolor{blue}{Barro (2006)}}):
		\begin{itemize}
...
\href{https://doi.org/10.1093/rfs/hhy131}{\textcolor{blue}{Hou, Xue and Zhang(2020)}} replicate anomalies
...
\begin{frame}{The Replication Crisis}
	\begin{itemize}
		...
		\item \href{https://doi.org/10.1111/jofi.12607}{\textcolor{blue}{Harvey, Liu, and Zhu (2016)}}: Multiple testing problem
		\begin{itemize}
			\item Need $t > 3.0$ for significance after adjustment
			\item Many published anomalies fail this hurdle
		\end{itemize}
		\item \href{https://doi.org/10.1093/rfs/hhaa019}{\textcolor{blue}{Jensen, Kelly, and Pedersen (2023)}}: Which factors truly matter?
		\begin{itemize}
...
\begin{frame}{Machine Learning in Asset Pricing}
	...
	\begin{itemize}
		\item \href{https://doi.org/10.1093/rfs/hhz123}{\textcolor{blue}{Gu, Kelly, and Xiu (2020)}}: ``Empirical Asset Pricing via Machine Learning''
		\begin{itemize}
			\item Compare ML methods for return prediction
			\item Neural networks outperform linear models
		\end{itemize}
		\item \href{https://doi.org/10.1111/jofi.12883}{\textcolor{blue}{Freyberger, Neuhierl, and Weber (2020)}}: Dissecting characteristics
		\item \href{https://doi.org/10.1093/rfs/hhaa009}{\textcolor{blue}{Chen, Pelger, and Zhu (2024)}}: Deep learning for factor models
	\end{itemize}
...
\begin{frame}{Homework: Detailed Instructions}
	...
	\begin{enumerate}
		\item \href{https://doi.org/10.1146/annurev-financial-110311-101826}{\textcolor{blue}{Nagel (2013)}}: Survey on cross-sectional asset pricing
